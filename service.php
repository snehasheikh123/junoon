                        ...
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption-1">
                                <div class="carousel-caption-1-content" style="max-width: 900px;">
                                    ...
                                    <h1 class="display-2 text-capitalize text-white mb-4 fadeInLeft animated" data-animation="fadeInLeft" data-delay="1.3s" style="animation-delay: 1.3s;">Services</h1>
                                    <p class="mb-5 fs-5 text-white fadeInLeft animated" data-animation="fadeInLeft" data-delay="1.5s" style="animation-delay: 1.5s;">Your use of the Services and Content must follow the rules set forth in this section ("Usage Rules"). Any other use of the Services and Content is a material breach of this Agreement. Infotel Services may monitor your use of the Services and Content to ensure that you are following these Usage Rules. 
                                    </p>
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption-2">
                                <div class="carousel-caption-2-content" style="max-width: 900px;">
                                    ...
                                    <h1 class="display-2 text-capitalize text-white mb-4 fadeInRight animated" data-animation="fadeInRight" data-delay="1.3s" style="animation-delay: 1.3s;">Services and Content Usage Rules</h1>
                                    <p class="mb-5 fs-5 text-white fadeInRight animated" data-animation="fadeInRight" data-delay="1.5s" style="animation-delay: 1.5s;"> Your use of the Services and Content must follow the rules set forth in this section ("Usage Rules"). Any other use of the Services and Content is a material breach of this Agreement. Infotel Services may monitor your use of the Services and Content to ensure that you are following these Usage Rules. 
                                    </p>
        ...
        <div class="container-fluid service bg-light overflow-hidden py-5">
            <div class="container py-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h4 class="text-uppercase text-primary">Junoon is a process where user can gain after investment through designed format.</h4>
                    <!-- <h1 class="display-3 text-capitalize mb-3">Junoon is a process where user can gain after investment through designed format.</h1> -->
                </div>
                <div class="card">
                   <center><h3 > Use Our Service Restrictions</h3></center> <br>
    <ul>
        <li>You must not use the Service if you are under the age of 18.</li>
        <li>You must deny anyone under 18 to use your account.</li>
        <li>You are fully responsible for any unauthorized use of the Service including but not limited to the use of credit card or any payment by any method.</li>
        <li>You shall not use your account for any illegal activity.</li>
        <li>You shall not use your account to transmit repetitive messages (spam), junk e-mail, advertise and solicit.</li>
        <li class="highlight">You shall not post any objectionable and offensive information including but not limited to abusive, threatening, racial, sexual, or obscene.</li>
        <li>You will not use your account to cheat or hack the process by any means.</li>
        <li>You shall not sublicense, lease, trade, gift, sell or otherwise transfer your account or associated virtual items partly or fully to anyone without written permission from Infotel Services.</li>
        <li>You shall not buy or purchase coins from any unauthorized source.</li>
        ...
        <li>You shall not register yourself if you do not agree with the term & condition and after that you will not file any judiciary case & claim to anywhere in India against Infotel Services.</li>
    </ul>
</div>
            </div>
        </div>
